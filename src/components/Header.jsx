...
function Header() {
  ...
  return (
    <>
      <div className="w-screen flex justify-around h-24 items-center top-0 md:hidden">
        ...
        <div className="w-[360px] h-[42px] rounded-3xl bg-navbg flex items-center justify-start pl-4 gap-4">
          <div>
            <svg
              width="22"
              height="22"
          ...
          <div>
            <input
              ...
              className="w-[242px] h-[19px] font-semibold text-gry font-ibm text-[14px] bg-navbg"
            />
          </div>
        </div>
        <div className="flex cursor-pointer" onClick={handlePopUp}>
          <span>Create Account.</span>
          <span className="text-blue-700 text-[16px] font-bold font-ibm">
            It's free!
          </span>
          <span>
            <svg
      ...
      {popUp && (
        <div className="w-[750px] flex flex-col items-end z-50 absolute left-[352px] top-[146px] gap-2 lg:left-[100px] md:hidden">
          ...
          <div className="w-[736px] h-[513px] rounded-lg bg-white z-50 shadow-2xl drop-shadow-2xl">
            <div className="bg-lightgreen rounded-t-lg w-full h-[50px] text-center text-green-600 font-ibm text-[14px] py-[17px] font-semibold">
              Let's learn, share & inspire each other with our passion for
              computer engineering. Sign up now 🤘🏼
            </div>
            <div className="px-8 py-6 flex justify-between">
              <div>
                <span className="text-[24px] font-ibm font-bold">
                  Create Account
                </span>
                <div className="w-[320px] h-[181px] mt-4 border">
                  <div className="flex w-full h-1/4">
                    <input
                      type="text"
                      className="font-ibm font-semibold text-[15px]  w-1/2 border h-[46px] px-2"
                  ...
                  <input
                    type="text"
                    className="font-ibm font-semibold text-[15px]  w-full h-[46px] border px-2"
                    placeholder="Email"
                  />
                  <input
                    type="text"
                ...
                <div>
                  <button className="w-[320px] bg-blue-600 text-center rounded-3xl font-ibm text-[14px] text-white font-semibold py-2 my-5">
                    Create Account
                  </button>
                </div>
                <div className="flex flex-col gap-3">
                  <button className="w-[320px] border font-ibm text-center text-[14px]flex py-1.5 font-[500] flex justify-center items-center gap-2">
                    <img
                  ...
                  <button className="w-[320px] border font-ibm text-center text-[14px]flex py-1.5 font-[500] flex justify-center items-center gap-2">
                    <img
                      src="https://i.ibb.co/7vp5561/search.png"
                      className="w-4"
                      alt=""
                    />
                    Sign up with Google
              ...
              <div className="flex flex-col items-end">
                <span>
                  <span className="font-ibm text-[13px] text-gry">
                    Already have an Account?
                  </span>
                  <span className="text-blue-600 font-ibm text-[13px] font-extrabold">
                    Sign In
                  </span>
                </span>
                ...
                <span className="font-ibm text-gray-400 text-[11px]">
